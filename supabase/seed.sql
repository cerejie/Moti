...
insert into demo_users (id, email, full_name, role, shop_id) values
  ('00000000-0000-4000-8000-000000000001', 'superadmin@moti.test', 'Moti Superadmin', 'superadmin', null),
