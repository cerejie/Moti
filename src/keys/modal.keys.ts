...
export const cartSheetModalKey = "cart-sheet";
export const transactionSuccessModalKey = "transaction-success";
export const transactionDetailModalKey = "transaction-detail";
export const voidTransactionModalKey = "void-transaction";
